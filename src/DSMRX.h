...
class DSMRX {
    ...
    public:
        ...
        void getChannelValues(uint16_t values[], uint8_t count)
        {
        ...
        void getChannelValuesNormalized(float values[], uint8_t count)
        {
            for (uint8_t k=0; k<count; ++k) {
